...
import org.repository.DAOInterface.InvoiceDAOInterface;
import org.repository.Mapper.ProductBOMapper;
import org.repository.Mapper.StockBOMapper;
import org.springframework.jdbc.core.JdbcTemplate;

public class InvoiceJDBCTemplate implements InvoiceDAOInterface{
	...
	@Override
	public void insertSaleInv(List<SaleBO> salBOli,String dbName){
...
/*			for (StockBO sbo : sboL) {
	...
	@Override
	public void updateSaleInv(List<SaleBO> salBOli,String dbName){
		try {
			Connection con = jdbcTemplateObject.getDataSource().getConnection();
			con.setAutoCommit(false);
			Statement stmt = con.createStatement();
...
/*	
	...
	@Override
	public List<SaleBO> searchSaleInv(SaleBO sbo,String dbName){
/*		String SQL="select * from "+dbName+".`stock` where productName like '%"+sbo.getProductID()+"%' and active='y'";
	...
	@Override
	public void insertPurInv(List<PurchaseBO> puBOli,String dbName){
...
/*			for (StockBO sbo : sboL) {
	...
	@Override
	public void updatePurInv(List<PurchaseBO> puBOli,String dbName){
		try {
			Connection con = jdbcTemplateObject.getDataSource().getConnection();
			con.setAutoCommit(false);
			Statement stmt = con.createStatement();
/*			for (StockBO sbo : sboL) {
	...
	@Override
	public List<PurchaseBO> searchPurInv(PurchaseBO pubo,String dbName){
/*		String SQL="select * from "+dbName+".`stock` where productName like '%"+sbo.getProductID()+"%' and active='y'";
		List<StockBO> stocks=jdbcTemplateObject.query(SQL, new StockBOMapper());
		return stocks;*/
		return null;
